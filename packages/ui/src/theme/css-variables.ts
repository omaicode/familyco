...
export const buildFamilyCoCssVariables = (theme: FamilyCoUITheme): Record<string, string> => ({
  ...
  '--fc-text-secondary': theme.colors.secondary,
  ...
  '--fc-secondary': theme.colors.secondary,
  '--fc-secondary-hover': theme.colors.secondaryHover,
  '--fc-secondary-foreground': theme.colors.secondaryForeground,
