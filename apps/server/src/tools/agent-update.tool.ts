...
export const agentUpdateTool: ServerToolDefinition = {
  ...
  parameters: [
    ...
    { name: 'aiAdapterId', type: 'openai | openrouter | claude | vercel | deepseek | null', required: false, description: 'Agent adapter override.' },
...
function asAdapter(value: unknown): 'openai' | 'openrouter' | 'claude' | 'vercel' | 'deepseek' | null | undefined {
  if (value === null) {
    return null;
  }
