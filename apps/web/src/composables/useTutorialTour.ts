...
const buildSteps = (t: (key: string) => string): DriveStep[] => [
  ...
  },
  {
    element: '#tour-cron',
    popover: {
      title: t('tour.step.cron.title'),
      description: t('tour.step.cron.desc'),
      side: 'right',
      align: 'center',
    },
  },
  ...
  },  
  {
    element: '#tour-audit',
    popover: {
      title: t('tour.step.audit.title'),
      description: t('tour.step.audit.desc'),
      side: 'right',
      align: 'center',
    },
  },    
  {
    element: '#tour-budget',
    popover: {
      title: t('tour.step.budget.title'),
      description: t('tour.step.budget.desc'),
      side: 'right',
      align: 'center',
    },
  },    
  {
    element: '#tour-skills',
    popover: {
      title: t('tour.step.skills.title'),
      description: t('tour.step.skills.desc'),
      side: 'right',
      align: 'center',
    },
  },   
